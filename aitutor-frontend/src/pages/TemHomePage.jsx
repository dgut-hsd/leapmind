...
export default function LearningApp({ onOpenProfile, onEnterProject, onM2PhotoQa, onM2Explain, onM5Create, onM5List }) {
  // UI 状态
  ...
  const features = [
    ...
    { title: "AI 备课", color: "from-emerald-400 via-teal-400 to-cyan-500", icon: null, custom: true, action: onM5List },
                ...
                feature.title === "AI 备课" ? (
                  <div className="flex items-center justify-center w-full h-full gap-3 px-3">
                    ...
                    <svg className="w-16 h-16 shrink-0" viewBox="0 0 80 80">
                      <rect x="18" y="14" width="22" height="52" rx="4" fill="white" opacity="0.85"/>
                      <rect x="22" y="18" width="14" height="44" rx="2" fill="#7C3AED" opacity="0.8"/>
                      <line x1="25" y1="26" x2="33" y2="26" stroke="white" strokeWidth="1.5" opacity="0.5"/>
                      <line x1="25" y1="32" x2="33" y2="32" stroke="white" strokeWidth="1.5" opacity="0.5"/>
                      <line x1="25" y1="38" x2="30" y2="38" stroke="white" strokeWidth="1.5" opacity="0.5"/>
                      <rect x="44" y="14" width="22" height="52" rx="4" fill="white" opacity="0.85"/>
                      <rect x="48" y="18" width="14" height="44" rx="2" fill="#059669" opacity="0.8"/>
                      <line x1="51" y1="26" x2="59" y2="26" stroke="white" strokeWidth="1.5" opacity="0.5"/>
                      <line x1="51" y1="32" x2="59" y2="32" stroke="white" strokeWidth="1.5" opacity="0.5"/>
                      <line x1="51" y1="38" x2="56" y2="38" stroke="white" strokeWidth="1.5" opacity="0.5"/>
                      <circle cx="40" cy="58" r="12" fill="white" opacity="0.3"/>
                      <path d="M36 55 L40 59 L46 52" stroke="#34D399" strokeWidth="2.5" fill="none" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
                    <div className="flex flex-col items-center justify-center flex-1">
                      <span className="text-5xl font-black text-white drop-shadow-2xl tracking-[0.15em] leading-none">AI</span>
                      <span className="text-3xl font-bold text-white drop-shadow-xl tracking-[0.25em] leading-tight">备 课</span>
